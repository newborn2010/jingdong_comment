...
# -*- coding: utf-8 -*-
"""
Created on Thu May 10 15:49:50 2018
...
pages = range(1,6)
for page in pages:
    url = 'https://honor.jd.com/view_search-394032-1000000904-1000000904-0-2-0-0-1-' + str(page) + '-60.html?keyword=%25E6%2589%258B%25E6%259C%25BA&isGlobalSearch=0&other=&isRedisstore=0'
...
# connect mysql
con = sql.connect(host='localhost', user='root',passwd='',db='honor',charset='utf8')
