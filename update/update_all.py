...
# import last time
with open('/Users/zt/Desktop/time_all.txt','r') as lt:
    last_time = lt.read()

# time
end_time = datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S')
with open('/Users/zt/Desktop/time_all.txt','w') as nt:
    nt.write(end_time)
    
# get id
brands = ['xiaomi', 'huawei', 'iphone','samsung', 'honor'] #'xiaomi', 'huawei', 'iphone','samsung', 'honor'
