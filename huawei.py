...
# -*- coding: utf-8 -*-
"""
Created on Sat Apr 28 23:39:12 2018
...
pages = range(1,6)
for page in pages:
    url = 'https://huawei.jd.com/view_search-466323-1000004259-1000004259-0-2-0-0-1-' + str(page) + '-60.html?keyword=%25E6%2589%258B%25E6%259C%25BA&isGlobalSearch=0&other=&isRedisstore=0'
