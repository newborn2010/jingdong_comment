...
# -*- coding: utf-8 -*-
"""
Created on Mon Apr 30 11:23:10 2018
...
pages = range(1,6)
for page in pages:
    url = 'https://samsung.jd.com/view_search-418163-1000003443-1000003443-0-2-0-0-1-' + str(page) + '-60.html?isGlobalSearch=0&other=&isRedisstore=0'
...
# connect mysql
con = sql.connect(host='localhost', user='root',passwd='',db='samsung',charset='utf8')
