...
# -*- coding: utf-8 -*-
"""
Created on Tue Apr 17 23:26:50 2018
...
pages = range(1,5)
for page in pages:
    url = 'https://greedianqi.jd.com/view_search-417603-1000003445-1000003445-0-2-0-0-1-'+ str(page) +'-80.html?isGlobalSearch=0&other='
...
# connect mysql
con = sql.connect(host='localhost', user='root',passwd='',db='geli',charset='utf8')
