...
# -*- coding: utf-8 -*-
"""
Created on Tue Apr 17 23:14:57 2018
...
pages = range(1,8)
for page in pages:
    url = 'https://haier.jd.com/view_search-398725-1000001782-1000001782-0-2-0-0-1-' + str(page) + '-60.html?isGlobalSearch=0&other='
...
# connect mysql
con = sql.connect(host='localhost', user='root',passwd='',db='haier',charset='utf8')
